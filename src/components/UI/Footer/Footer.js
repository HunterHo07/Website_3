...
但是，谁能正确地批评一个人想要沉浸在不会带来不适的快乐中，或者谁会避免痛苦而不会产生快乐呢？"
          ...
          <div className='col-sm-6 col-md-6 col-lg-3 mb-5'>
            ...
            <div className='footer-content'>
              <p className='text-muted'>
                <small>Address : Kuala Lumper, Malaysia</small>
              </p>
              <p className='text-muted'>
                <small>Phone : +60 (010) 1231234</small>
              </p>
              <p className='text-muted'>
                <small>E-mail : HunterHo.My@Gmail.com</small>
              </p>
      ...
      <div className='bottom-footer pt-3 pb-3 text-center'>
        <small>© All Right Reserved. Design By Hunter Ho</small>
      </div>
    </footer>
  );
};
